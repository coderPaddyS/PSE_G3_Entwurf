\subsubsection{IAddAliasController}\label{App_AddAlias_IAddAliasController}
\paragraph*{Typ}
\texttt{Interface}.
...
\subsubsection*{\texttt{+ addLocalAlias(mapId : int, alias : String)}}\label{App_AddAlias_IAddAliasController_addLocalAlias}%$$$M
\paragraph*{Beschreibung}
...
\subsubsection*{\texttt{+ suggestGlobalAlias(mapId : int, alias : String) : boolean}}\label{App_AddAlias_IAddAliasController_suggestGlobalAlias}%$$$M
...
\subsubsection*{\texttt{+ getMapObjectData(mapId : int) : (String, String))}}\label{App_AddAlias_IAddAliasController_getMapObjectData}%$$$M
\paragraph*{Kurzbeschreibung}
...
\subsubsection*{\texttt{+ getGlobalAliases(mapId : int) : List<String>}}\label{App_AddAlias_IAddAliasController_getGlobalAliases}%$$$M
\paragraph*{Beschreibung}
...
%-----------------------------------------------
\subsubsection{AddAliasController}\label{App_AddAlias_AddAliasController}
\paragraph*{Typ}
...
Außerdem stellt er existierende Aliasse bereit.\\
Seine Daten bezieht er von der Model-Klasse \hyperref[App_AddAlias_IAliasDataProvider]{IAddAliasDataProvider}.