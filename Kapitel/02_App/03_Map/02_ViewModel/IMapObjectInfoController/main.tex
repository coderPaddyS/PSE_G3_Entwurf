\subsubsection{IMapObjectInfoController}\label{App_Map_ViewModel_IMapObjectInfoController}
\paragraph*{Typ}
\texttt{Interface}.
...
\subsubsection*{\texttt{+ getBuildingAddress(mapId : int) : String}}\label{App_Map_ViewModel_getBuildingAddress}%$$$M
\paragraph*{Beschreibung}
...
\subsubsection*{\texttt{+ getRoomInfo(mapId : int) : (RoomType, String, int, List<String>)}}\label{App_Map_ViewModel_getRoomInfo}%$$$M
...
\subsubsection*{\texttt{+ getGlobalAliases(mapId : int) : List<String>}}\label{App_Map_ViewModel_getGlobalAliases}%$$$M
\paragraph*{Beschreibung}
...
\subsubsection*{\texttt{+ getLocalAliases(mapId : int) : LiveData<List<String>>}}\label{App_Map_ViewModel_getLocalAliases}%$$$M
\paragraph*{Beschreibung}
...
\subsubsection*{\texttt{+ deleteLocalAlias(mapId : int, alias : String)}}\label{App_Map_ViewModel_deleteLocalAlias}%$$$M
\paragraph*{Kurzbeschreibung}
...
\subsubsection*{\texttt{+ getAliasSuggestions(mapId : int) : LiveData<List<String>>}}\label{App_Map_ViewModel_getAliasSuggestions}%$$$M
\paragraph*{Kurzbeschreibung}
...
\subsubsection*{\texttt{+ giveAliasFeedback(mapId : int, suggestion : String, feedback : SuggestionFeedback) : boolean}}\label{App_Map_ViewModel_giveAliasFeedback}%$$$M
\paragraph*{Kurzbeschreibung}
