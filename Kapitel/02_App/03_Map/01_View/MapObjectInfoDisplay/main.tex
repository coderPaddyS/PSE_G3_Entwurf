\subsubsection{MapObjectInfoDisplay}\label{App_Map_View_MapObjectInfoDisplay}
\paragraph*{Typ}
\texttt{Composable}.
...
\paragraph*{Ausführliche Anzeige}
...
\begin{minipage}{\linewidth}
    ...
    \begin{minipage}{.49\textwidth}
        ...
        \captionof{figure}{Kompakte Ansicht}
        \captionsetup[figure]{labelformat=default}
    \end{minipage}
    \begin{minipage}{.49\textwidth}
        \captionsetup[figure]{labelformat=empty}
        \inprelimg[width=\textwidth]{Gebaudeinformation.png}
        \captionof{figure}{Ausführliche Ansicht}
        \captionsetup[figure]{labelformat=default}
    \end{minipage}
\end{minipage}