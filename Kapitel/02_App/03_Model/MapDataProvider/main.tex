...
\subsubsection{+getRoomDisplayData(mapId:int, level:int):LiveData<List<DisplayData>>}%$$$M
...
\subsubsection{+getBuildingDisplayData():LiveData<List<DisplayData>>}%$$$M
\paragraph*{Beschreibung}
...
\subsubsection{+getLastSavedPosition():IGeoPoint}%$$$M
\paragraph*{Kurzbeschreibung}
...
\subsubsection{+savePosition(pos:IGeoPoint)}%$$$M
\paragraph*{Beschreibung}
