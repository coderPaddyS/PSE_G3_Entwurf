...
\begin{itemize}
    ...
    Wählt er davon eine aus, zeigt die App wieder die Gesamtansicht der Einstellungen an. Die App wird in der ausgewählten Sprache angezeigt.\\
    ...
    Wählt er davon eines aus, zeigt die App wieder die Gesamtansicht der Einstellungen an. Die App wird im gewählten Theme angezeigt.\\
    Im Untermenü befindet sich oben links ein Zurück-Button. Wird dieser gedrückt oder die Zurückfunktion des Endgeräts betätigt, 
    wird ebenfalls wieder die Gesamtansicht angezeigt.
