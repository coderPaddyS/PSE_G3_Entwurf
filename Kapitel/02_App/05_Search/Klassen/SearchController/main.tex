\subsubsection{ISearchController}\label{App_Search_ISearchController}
\paragraph*{Typ}
\texttt{Interface}.
...
\subsubsection*{\texttt{+ getSuggestions() : LiveData<List<String>>}}\label{App_Search_ISearchController_getSuggestions}%$$$M
\paragraph*{Beschreibung}
...
\subsubsection*{\texttt{+ setInput(input : String)}}\label{App_Search_ISearchController_setInput}%$$$M
\paragraph*{Beschreibung}
...
\subsubsection*{\texttt{+ confirmInput()}}\label{App_Search_ISearchController_confirmInput}%$$$M
\paragraph*{Beschreibung}
...
\subsubsection*{\texttt{+ selectSuggestion(suggestion : String)}}\label{App_Search_ISearchController_selectSuggestion}%$$$M
\paragraph*{Beschreibung}
