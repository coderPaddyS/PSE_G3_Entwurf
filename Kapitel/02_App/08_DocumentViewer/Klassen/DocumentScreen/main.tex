\subsubsection{DocumentScreen}\label{App_DocumentViewer_DocumentScreen}
\paragraph*{Typ}
\texttt{Composable}.
...
\subsubsection*{\texttt{+ onClickBack()}}\label{App_DocumentViewer_DocumentScreen_onClickBack}%$$$M
\paragraph*{Beschreibung}
...
\subsubsection*{\texttt{+ onClickReturn()}}\label{App_DocumentViewer_DocumentScreen_onClickReturn}%$$$M
\paragraph*{Beschreibung}
