...
\subsubsection{+ selectMapObject(mapId : int)}%$$$M
...
\subsubsection{+ getTileSource() : LiveData<\href{https://osmdroid.github.io/osmdroid/javadocAll/org/osmdroid/tileprovider/tilesource/ITileSource.html}{ITileSource}>}%$$$M
\paragraph*{Kurzbeschreibung}
...
\subsubsection{+ getMapObjectData() : LiveData<List<DisplayData>>}%$$$M
\paragraph*{Beschreibung}
...
\subsubsection{+ getFocusedMapId() : LiveData<int>}%$$$M
\paragraph*{Beschreibung}
...
\subsubsection{+ isFloorFocus() : LiveData<boolean>}%$$$M
\paragraph*{Kurzbeschreibung}
