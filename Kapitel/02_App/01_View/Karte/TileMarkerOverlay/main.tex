...
\subsubsection{+ <<create>> TileMarkerOverlay(controller:MapLayerDataController)}%$$$M
...
\subsubsection{+ onMarkerTap(mapId:int)}%$$$M
\paragraph*{Beschreibung}
...
\subsubsection{# createMarker(data:DisplayData):MapObjectMarker {abstract}}%$$$M
\paragraph*{Beschreibung}
...
\subsubsection{# createMarker(data:DisplayData):MapObjectMarker}%$$$M
\paragraph*{Kurzbeschreibung}
