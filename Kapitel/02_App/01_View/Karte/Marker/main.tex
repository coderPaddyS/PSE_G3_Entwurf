...
\subsubsection{+ <<create>> MapObjectMarker(mapView : MapView, data : DisplayData, tileMarkerOverlay : TileMarkerOverlay)}%$$$M
\paragraph*{Beschreibung}
...
\subsubsection{+ onSingleTapConfirmed(e : MotionEvent, mapView : MapView) : boolean}%$$$M
\paragraph*{Beschreibung}
...
\subsubsection{+ focusMarkerObject(floorMapExists : boolean) {abstract}}%$$$M
\paragraph*{Beschreibung}
...
\subsubsection{+ focusMarkerObject(floorMapExists : boolean)}%$$$M
