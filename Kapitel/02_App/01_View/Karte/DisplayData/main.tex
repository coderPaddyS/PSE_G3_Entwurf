...
\subsubsection{+ <<create>> DisplayData(latitude : double, longitude : double, name : String, mapId : int)}%$$$M
\paragraph*{Beschreibung}
...
\subsubsection{+ getPosition() : IGeoPoint}%$$$M
\paragraph*{Beschreibung}
...
\subsubsection{+ getName() : String}%$$$M
\paragraph*{Beschreibung}
