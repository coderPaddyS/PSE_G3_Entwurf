\subsection{\texttt{getAlias(mapID : int, userID : UserID) : List<Alias> aliases}}%$$$M
\paragraph*{Kurzbeschreibung}
Gibt die Anweisung an Klasse \texttt{AliasRepository}, eine Liste der Aliasse des gewünschten Kartenobjekts, die ein bestimmter Benutzer ursprünglich vorgeschlagen hatte, zurückzugeben, und gibt es wiederum zurück.
