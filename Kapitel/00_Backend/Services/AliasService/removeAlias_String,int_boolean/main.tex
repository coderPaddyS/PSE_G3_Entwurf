\subsection{\texttt{removeAlias(alias : String, mapID : int) : boolean}}%$$$M
\paragraph*{Kurzbeschreibung}
Gibt die Anweisung an die Klasse \texttt{AliasRepository}, einen globalen Alias aus der Datenbank zu entfernen.
