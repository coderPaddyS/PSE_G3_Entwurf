\paragraph{\texttt{getAlias(mapID : int, user : String) : List<Alias> aliases}}%$$$M
...
Hierfür wird die ID des gewünschten Kartenobjekts und das Pseudonym des gewünschten Benutzers übergeben.
\paragraph*{Parameter}
\begin{itemize}
    \item mapID : int
    		\paragraph*{Beschreibung}
    	...
    	\item user : String
    		\paragraph*{Beschreibung}
    		Das Pseudonym des Benutzers, dessen Aliasse man zurückgegeben haben möchte.
\end{itemize}
