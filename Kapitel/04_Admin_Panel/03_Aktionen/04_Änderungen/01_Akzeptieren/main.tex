\subsubsection{Akzeptieren}\label{AP_Aktionen_Änderungen_Akzeptieren}
...
\begin{enumerate}
    \item Auf der zur Änderung gehörende Instanz von \verb#Change# wird die Methode \verb#Change::perform# ausgeführt.
