\newpage
\subsubsection{Akzeptiere Alle}\label{AP_Aktionen_Änderungen_Akzeptiere_Alle}
...
\begin{enumerate}
    \item Rufe auf jeder Änderung die Methode \verb#Change::perform#  der zugehörenden Instanz von \verb#Change# auf.
